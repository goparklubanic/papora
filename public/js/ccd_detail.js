    ...
    fetch(apiurl + "/desc/detail/" + detail_id)
        ...
        .then((data) => {
            ...
            ss_indikator.forEach((ind) => {
                let editi = `<a href="${weburl}/edit/indikator/${ind.master_ik}" class="text-primary float-end fw-normal text-decoration-none d-none edit-link">Edit</a>`;
                $("#ss_indikator").append(`
                    <tr>
                        <td>${ind.indikator}</td>
                        <td>${ind.satuan}</td>
