...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/likgopar/Projects/Laravels/papora/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./home/likgopar/Projects/Laravels/papora/public/storage','logging.default','logging.deprecations.channel',
...
'ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','renstra.index','renstra.jelajah','renstra.detail','renstra.view',
'renstra.print','edit.deskripsi','edit.indikator','logout','api_v0_desc.index',
'api_v0_desc.fetch','api_v0_desc.getTujuan','api_v0_desc.getSasaran','api_v0_desc.getProgram','api_v0_desc.getKegiatan',
'api_v0_desc.getSubkegiatan','api_v0_desc.detailcode','api_v0_desc.detail','api_v0_desc.getdescription','api_v0_desc.setdesctiption',
'api_v0_desc.getindikator','api_v0_desc.setindikator','api_v0_desc.getallindikator','api_v0_desc.getbudget',);
        registerArgumentsSet('views', 
'dashboard','generator_id','index','layouts.app','layouts.footer',
'layouts.navbar','renstra.desc_edit','renstra.detail','renstra.index','renstra.indi_edit',
'renstra.indi_print','renstra.indi_view','renstra.jelajah','welcome','laravel-exceptions-renderer::components.card',
...
'LOG_LEVEL','DB_CONNECTION','DB_DATABASE','SESSION_DRIVER','SESSION_LIFETIME',
