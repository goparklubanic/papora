...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('ccd_budgets', function (Blueprint $table) {
            ...
            $table->decimal('tt1_tw2', 10, 2)->default(0.00);
            $table->decimal('tt1_tw3', 10, 2)->default(0.00);
            $table->decimal('tt1_tw4', 10, 2)->default(0.00);
            $table->decimal('tt2_tw1', 10, 2)->default(0.00);
            $table->decimal('tt2_tw2', 10, 2)->default(0.00);
            $table->decimal('tt2_tw3', 10, 2)->default(0.00);
            $table->decimal('tt2_tw4', 10, 2)->default(0.00);
            $table->decimal('tt3_tw1', 10, 2)->default(0.00);
            $table->decimal('tt3_tw2', 10, 2)->default(0.00);
            $table->decimal('tt3_tw3', 10, 2)->default(0.00);
            $table->decimal('tt3_tw4', 10, 2)->default(0.00);
            $table->decimal('tt4_tw1', 10, 2)->default(0.00);
            $table->decimal('tt4_tw2', 10, 2)->default(0.00);
            $table->decimal('tt4_tw3', 10, 2)->default(0.00);
            $table->decimal('tt4_tw4', 10, 2)->default(0.00);
            $table->decimal('tt5_tw1', 10, 2)->default(0.00);
            $table->decimal('tt5_tw2', 10, 2)->default(0.00);
            $table->decimal('tt5_tw3', 10, 2)->default(0.00);
            $table->decimal('tt5_tw4', 10, 2)->default(0.00);
            $table->decimal('ct1_tw1', 10, 2)->default(0.00);
